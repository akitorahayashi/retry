...
- source_event: "test_granularity_qa.md"
...
- New test cases should not slow down the overall suite excessively.
- Reuse setup context using `beforeEach` to avoid duplication.

## Acceptance Criteria

- All assertions testing multiple independent logical outcomes are split into individual test definitions (`it(...)`).
